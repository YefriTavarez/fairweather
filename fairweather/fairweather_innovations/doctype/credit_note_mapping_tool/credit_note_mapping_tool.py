...
class CreditNoteMappingTool(Document):
    def onload(self):
        ...
        message = """
                <p>This feature is deprecated and will be removed in the near future.</p>
                <p>Please use the new <a href="/app/credit-mapping-tool">Credit Mapping Tool</a> instead.</p>
            """
    ...
    def _apply_outstanding_amount_to_invoice(self, credit_note_balance):
        ...
        journal_entry = get_journal_entry(
            credit_note, sales_invoice, mapping_tool)
    ...
    def validate_mandatory_fields(self):
        for fieldname in ("customer", "credit_note", "sales_invoice", "amount_to_apply"):
            ...
            message = "Required: {label} is a mandatory field!".format(
                label=label)
    ...
    def validate_credit_note_against_invoice(self):
        ...
        sales_invoice_customer = get_value(
            doctype, self.sales_invoice, "customer")
